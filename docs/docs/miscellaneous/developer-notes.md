...
2. run `npm i`
3. globally find and replace older version number referenced in _docs/docs_ folder wherever appropriate
4. update _version_ in _helm/Chart.yaml_ to match _version_ in _package.json_
