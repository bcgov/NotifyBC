...
const _hoisted_31 = {
  href: "https://github.com/f-w/jmespath.js",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_32 = {
  href: "http://jmespath.org/",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_33 = /* @__PURE__ */ createBaseVNode(
  "a",
  { href: "../api-subscription#broadcastPushNotificationFilter" },
...
const _hoisted_34 = /* @__PURE__ */ createBaseVNode(
  "a",
  { href: "../api-notification#broadcastPushNotificationSubscriptionFilter" },
...
const _hoisted_35 = /* @__PURE__ */ createBaseVNode(
  "em",
  null,
  "notification.broadcastCustomFilterFunctions",
  -1
  /* HOISTED */
);
...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("p", null, [
      createTextVNode("For example, to notify subscribers of "),
      _hoisted_6,
      createTextVNode(" on updates to feed "),
      _hoisted_7,
      createTextVNode(", create following config item using "),
      createVNode(_component_RouterLink, { to: "/docs/api-config/#create-a-configuration" }, {
        default: withCtx(() => [
          createTextVNode("POST configuration API")
        ]),
        _: 1
        /* STABLE */
      })
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        ...
        createBaseVNode("ul", null, [
          ...
          createBaseVNode("li", null, [
            _hoisted_11,
            createTextVNode("timeSpec: RSS poll frequency, a space separated fields conformed to "),
      ...
      createBaseVNode("li", null, [
        createTextVNode("httpHost: the http protocol, host and port used by "),
        ...
        createTextVNode(". If missing, the value is auto-populated based on the REST request that creates this config item.")
      ]),
      createBaseVNode("li", null, [
        createTextVNode("messageTemplates: channel-specific message templates with channel name as the key. "),
        _hoisted_18,
        createTextVNode(" generates a notification for each channel specified in the message templates. Message template fields are the same as those in "),
        createVNode(_component_RouterLink, { to: "/docs/api-notification/#field-message" }, {
          default: withCtx(() => [
            createTextVNode("notification api")
          ]),
          _: 1
          /* STABLE */
        }),
        createTextVNode(". Message template fields support dynamic token.")
      ])
    ]),
    _hoisted_19,
    createBaseVNode("p", null, [
      createTextVNode("To support rule-based notification event filtering, "),
      _hoisted_30,
      createTextVNode(" uses a "),
      createBaseVNode("a", _hoisted_31, [
        createTextVNode("modified version"),
        createVNode(_component_ExternalLinkIcon)
      ]),
      createTextVNode(" of "),
      createBaseVNode("a", _hoisted_32, [
        createTextVNode("jmespath"),
        createVNode(_component_ExternalLinkIcon)
      ]),
      createTextVNode(" to implement json query. The modified version allows defining custom functions that can be used in "),
      _hoisted_33,
      createTextVNode(" field of subscription API and "),
      _hoisted_34,
      createTextVNode(" field of subscription API. The functions must be implemented using JavaScript in config "),
      _hoisted_35,
      createTextVNode(". The functions can even be "),
      _hoisted_36,
      createTextVNode(". For example, the case-insensitive string matching function "),
      _hoisted_37,
      createTextVNode(" shown in the example of that field can be created in file "),
      _hoisted_38
    ]),
    _hoisted_39,
    createBaseVNode("p", null, [
      createTextVNode("Consult jmespath.js source code on the "),
      createBaseVNode("a", _hoisted_40, [
        createTextVNode("functionTable syntax"),
        createVNode(_component_ExternalLinkIcon)
      ]),
      createTextVNode(" and "),
      createBaseVNode("a", _hoisted_41, [
        createTextVNode("type constants"),
        createVNode(_component_ExternalLinkIcon)
      ]),
      createTextVNode(" used by above code. Note the function can use any Node.js modules ("),
    ...
    _hoisted_43,
    createBaseVNode("p", null, [
      createTextVNode("Guaranteed processing doesn't mean notification will be dispatched to every intended subscriber, however. Dispatch can still be rejected by smtp/sms server. Furthermore, even if dispatch is successful, it only means the sending is successful. It doesn't guarantee the recipient receives the notification. "),
      ...
      createTextVNode(" may occur for a successful dispatch, for instance; or the recipient may not read the message.")
    ]),
    createBaseVNode("p", null, [
      createTextVNode("The guarantee comes at a performance penalty because result of each dispatch is written to database one by one, taking a toll on the database. It should be noted that the "),
      createVNode(_component_RouterLink, { to: "/docs/miscellaneous/benchmarks.html" }, {
        default: withCtx(() => [
          createTextVNode("benchmarks")
        ]),
        _: 1
        /* STABLE */
      }),
      createTextVNode(" were conducted without the guarantee.")
    ]),
    _hoisted_48
  ]);
}
...
//# sourceMappingURL=index.html-c7098d1a.js.map
